...
def test_char(tmpdir):
    ...
    filepath_vds = os.path.join(base_path,'tests','test_data','skywater_char_PMOS_1V8_vds.raw')  # Vds data path
    filepath_vgs = os.path.join(base_path,'tests','test_data','skywater_char_PMOS_1V8_vgs.raw')  # Vgs data path
    ...
    correct_html = open(os.path.join(base_path,'tests','test_data','summary_skywater_PMOS_1V8_p.html'),'r')
