...
save all
dc vg 0 1.8 0.01 
*plot all.Vn_long#branch vs vgs
write skywater_char_NMOS_vgs.raw
.endc
" }
...
C {devices/lab_pin.sym} 360 -580 0 0 {name=l3 sig_type=std_logic lab=G1v8}
