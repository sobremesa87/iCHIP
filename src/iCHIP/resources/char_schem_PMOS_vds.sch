...
N 360 -540 400 -540 { lab=D1v8}
N 440 -620 490 -620 { lab=vds}
...
save all
dc vd 0 1.8 0.01 
*plot all.Vp_long#branch vs vds


*save @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]
*wrdata test_nmos.output i(vd1)
write skywater_char_PMOS_vds.raw
.endc
" }
...
C {devices/lab_pin.sym} 490 -620 0 0 {name=l2 sig_type=std_logic lab=vds}
C {devices/lab_pin.sym} 360 -580 0 0 {name=l3 sig_type=std_logic lab=S}
C {devices/lab_pin.sym} 360 -540 0 0 {name=l4 sig_type=std_logic lab=D1v8}
