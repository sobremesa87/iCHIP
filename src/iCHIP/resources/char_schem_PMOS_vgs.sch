...
N 440 -210 440 -190 {lab=D1v8}
N 690 -240 710 -240 {lab=B}
N 630 -240 650 -240 {lab=G1v8}
N 690 -290 690 -270 {lab=#net2}
N 690 -210 690 -190 {lab=D1v8}
N 440 -370 440 -350 { lab=S}
N 690 -370 690 -350 { lab=S}
N 390 -370 1370 -370 { lab=S}
N 940 -240 960 -240 {lab=B}
N 940 -290 940 -270 {lab=#net3}
N 940 -210 940 -190 {lab=D1v8}
N 1190 -240 1210 -240 {lab=B}
N 1130 -240 1150 -240 {lab=G1v8}
N 1190 -290 1190 -270 {lab=#net4}
N 1190 -210 1190 -190 {lab=D1v8}
N 940 -370 940 -350 { lab=S}
N 1190 -370 1190 -350 { lab=S}
N 880 -240 900 -240 {lab=G1v8}
N 440 -530 440 -480 { lab=GND}
N 440 -620 440 -590 { lab=vgs}
N 360 -580 400 -580 { lab=S}
N 360 -540 400 -540 { lab=G1v8}
N 440 -620 500 -620 { lab=vgs}
...
C {devices/lab_pin.sym} 390 -370 0 0 {name=p17 lab=S}
C {devices/lab_pin.sym} 440 -190 0 1 {name=p3 lab=D1v8}
C {devices/lab_pin.sym} 460 -240 0 1 {name=p4 lab=B}
C {devices/ammeter.sym} 440 -320 0 0 {name=Vp_lvt_long current=5.7132e-04}
C {devices/lab_pin.sym} 690 -190 0 1 {name=p11 lab=D1v8}
C {devices/lab_pin.sym} 710 -240 0 1 {name=p21 lab=B}
C {devices/ammeter.sym} 690 -320 0 0 {name=Vp_long current=5.0094e-04}
...
save all
dc vg 0 1.8 0.01 
*plot all.Vp_long#branch vs vgs


*save @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]
*wrdata test_nmos.output i(vd1)
write skywater_char_PMOS_vgs.raw
.endc
" }
...
"}
C {devices/lab_pin.sym} 940 -190 0 1 {name=p12 lab=D1v8}
C {devices/lab_pin.sym} 960 -240 0 1 {name=p5 lab=B}
C {devices/ammeter.sym} 940 -320 0 0 {name=Vp_lvt_short current=5.7132e-04}
C {devices/lab_pin.sym} 1190 -190 0 1 {name=p13 lab=D1v8}
C {devices/lab_pin.sym} 1210 -240 0 1 {name=p8 lab=B}
C {devices/ammeter.sym} 1190 -320 0 0 {name=Vp_short current=5.0094e-04}
...
C {sky130_fd_pr/pfet_01v8.sym} 670 -240 0 0 {name=M6
L=2
W=10
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 420 -240 0 0 {name=M7
L=2
W=10
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 1170 -240 0 0 {name=M8
L=0.35
W=10
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 920 -240 0 0 {name=M9
L=0.35
W=10
nf=1
mult=1
...
C {devices/lab_pin.sym} 360 -580 0 0 {name=l3 sig_type=std_logic lab=S}
C {devices/lab_pin.sym} 360 -540 0 0 {name=l4 sig_type=std_logic lab=G1v8}
C {devices/gnd.sym} 440 -480 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 500 -620 0 0 {name=l2 sig_type=std_logic lab=vgs}
